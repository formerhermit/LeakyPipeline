...
function NavFunction() {
  ...
  var questions = [[{ "QUESTION": "SCHOOL STAGE: Only 33% of girls (compared to 80% of boys) who take maths and science GCSEs will progress into STEM at A-level or equivalent. Many professional STEM occupations require qualification at Level 4 or above, and only 7% of the girls (compared to 21% of boys) who take STEM GCSEs will go on to qualify at Level 4 in a Core STEM area (WISE 2016a). What can your organisation do to help?", 
                  ...
                  [{ "QUESTION": "CAREER STAGE: Men often face social stigma for being a caregiver, making it harder for them to work part-time to care for their children, and making it hard for women to be the main career individual in the relationship (UK Government 2014). Is this something an organisation can have input on? If so how?", 
                  ...
                  { "QUESTION": "CAREER STAGE: Gender Bias issues are prevalent in the career field for STEM industries (Reuben et al. 2014) leading to reduction in recruitment of women, or unequal treatment in the workplace. Women may be unintentionally treated differently in your organisation – what can you do to solve this issue?", 
